...
const Crashed = () => {
  ...
  return (
    <div className="Crashedwrapper bgDesign h-[100vh] w-[100vw] overflow-hidden relative ">
      ...
      {/* All drones start  */}
      <div className="Crashed glassshadow p-1.5 h-[80%] backdrop-blur-sm w-[95%] mx-auto relative z-30 rounded-xl   ">
        {/* min nav start  */}
        ...
        <div class="dronesTable mt-12 mx-1 relative overflow-x-auto shadow-md sm:rounded-ss-lg sm:rounded-se-lg bg-transparent h-[85%]">
          ...
          {!loading ?  <tbody>
              {droneAllData.map((item, index) => (
                <tr
                  class=" border-b bg-red-50 dark:border-gray-300 my-2"
                  key={index}
                ...
                >
                  ...
                  <td class="px-6 py-2 text-red-400">
                  ...
                  <td class="px-6 py-2 ">
                      ...
                      <div className="Status p-1 rounded-md opacity-90 bg-red-200 border text-center font-semibold border-red-500 text-red-500">
                        Crashed
                      </div>
